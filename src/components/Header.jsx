...
const Header = () => {
  return (
    <div className='navBar flex items-center justify-between w-[70%] left-56 mt-5 rounded-full fixed z-50'>
        ...
        <ul className='flex justify-between w-[46%] items-center'>
          <li>
          ...
          <li>
           <Link
             to="/Contact"
             className="text-white bg-orange-700 hover:bg-orange-800 rounded-full text-lg px-5 lg:px-5 py-2 lg:py-2.5 focus:outline-none"
             >
             Contact
           </Link>
          </li>
